    ...
    <main className="min-h-screen pt-20">
      <section className="bg-gradient-to-br from-primary via-primary-dark to-primary-light text-primary-foreground py-16">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mt-6">Privacy Policy</h1>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 space-y-8 max-w-4xl leading-relaxed">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-2">For the purposes of this Privacy Policy:</p>
            <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
              ...
              <li>
                ...
                refers to hunter logistics pvt. ltd., 4th Floor / 416 Omega Business Park, Road No. 33, Wagle
                Industrial Estate, Thane (W), 400604.
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              ...
              browser You use, unique device identifiers and other diagnostic data. We may also collect information that
              Your browser sends whenever You visit Our Service or when You access the Service by or through a mobile
              device.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-1 text-muted-foreground mb-4">
              <li>
                <strong>Necessary / Essential Cookies</strong> (Type: Session Cookies; Administered by: Us) — These
                Cookies are essential to provide You with services available through the Website and to enable You to
                use some of its features. They help to authenticate users and prevent fraudulent use of user accounts.
              ...
              <li>
                <strong>Cookies Policy / Notice Acceptance Cookies</strong> (Type: Persistent Cookies; Administered by:
                Us) — These Cookies identify if users have accepted the use of cookies on the Website.
              </li>
              <li>
                <strong>Functionality Cookies</strong> (Type: Persistent Cookies; Administered by: Us) — These Cookies
                allow us to remember choices You make when You use the Website, such as remembering your login details
                or language preference. The purpose of these Cookies is to provide You with a more personal experience
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-2">The Company may use Personal Data for the following purposes:</p>
            <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
            ...
            <p className="text-muted-foreground mt-4 mb-2">We may share Your personal information in the following situations:</p>
            <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
              <li>
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              ...
              legal obligations, resolve disputes, and enforce our legal agreements and policies. The Company will also
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              ...
              other governmental jurisdiction where the data protection laws may differ from those from Your
              jurisdiction. Your consent to this Privacy Policy followed by Your submission of such information
              represents Your agreement to that transfer. The Company will take all steps reasonably necessary to ensure
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              ...
              collected about You. Our Service may give You the ability to delete certain information about You from
              within the Service. You may update, amend, or delete Your information at any time by signing in to Your
              Account, if you have one, and visiting the account settings section that allows you to manage Your
              personal information. You may also contact Us to request access to, correct, or delete any personal
              information that You have provided to Us. Please note, however, that We may need to retain certain
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-3">Detailed Information on the Processing of Your Personal Data</h2>
            <p className="text-muted-foreground">
            ...
            <h3 className="text-xl font-semibold mt-4 mb-2">Usage, Performance and Miscellaneous</h3>
            <p className="text-muted-foreground mb-2">We may use third-party Service Providers to maintain and improve our Service.</p>
            <h4 className="text-lg font-semibold mb-2">Google Places</h4>
            <p className="text-muted-foreground">
              Google Places is a service that returns information about places using HTTP requests. It is operated by
              Google. Google Places service may collect information from You and from Your Device for security
              purposes. The information gathered by Google Places is held in accordance with the Privacy Policy of
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              ...
              take steps to remove that information from Our servers. If We need to rely on consent as a legal basis for
