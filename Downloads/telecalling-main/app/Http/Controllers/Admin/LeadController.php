...
class LeadController extends Controller
{
    ...
    public function fetchAgentLeadList(Request $request)
    {
        $agent = $request->user();
        $leads = Lead::where('agent_id', $agent->id)->get();
        if ($leads) {
            return response()->json([
                'status' => true,
                'message' => 'Successfully fetched lead list.',
    ...
    public function agentLeadList(Request $request)
    {
        try {
            ...
            $sheat = Sheat::where('id', $request->sheat_id)->whereJsonContains('agents', (string) $agent->id)->first();
            if (!$sheat) {
                return response()->json([
                    'status' => false,
                    'message' => 'Unauthorized access.',
    ...
    public function followUpLead(Request $request)
    {
        try {
            ...
            $followUpLeads = Lead::whereDate('follow_up', $today)->where('agent_id', $agent->id)->get();
            if ($followUpLeads) {
                return response()->json([
                    'status' => true,
                    'message' => 'Successfully fetched lead list.',
